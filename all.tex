...
computes $\bB=(b_1,\dots,b_m)$ using $\sigma'=O(\sigma + {q \choose p} n^3 + n^2
...
T_{\rm row}(\sigma,\bgamma,(\alpha_1,\dots,\alpha_p),q)= \gamma_1 \cdots\gamma_s T + \softO( c(e+c^5 )(\sigma + cn^4)),  
\end{align}
...
\begin{proof}
  ...
  $\sigma=O(nq(\alpha_1 + \cdots + \alpha_p))$; following our convention in
  the previous section, the runtime $T_{\rm row}(\sigma,\bgamma,(\alpha_1,\dots,\alpha_p),q)$
