...
as Hahn series): all elements of $\SS$ can be written as
...
too \cite[Theorem 1]{Mclane39}. Actually, it is an
...
characteristic greater than $n \ c^2$ \xxx. When this is the case,
...
\begin{proposition}\label{prop:coldeg}
  ...
  When $\KK$ has characteristic $0$ or larger than $8 \ n c^2$ \xxx,
