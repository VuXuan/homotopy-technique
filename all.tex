...
Any algebraic set is the finite union of its \emph{irreducible
...
For any ideal $I$ in $\KK[X_1,\dots,X_n]$, $V(I)$ will denote the
zero-set of $I$ in $\KKbar{}^n$. The ideal $I$ can be written as the
