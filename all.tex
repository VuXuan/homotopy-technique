...
simplified to
\[
  \softO\left ({q \choose p} n^3 c(e+c^5 )(\sigma +\gamma + q
    \delta)\right).
\]
...
runtime $\softO(m \,n^2 c^2 + c\,e\,n (\sigma'+n^2) )$ operations
in $\KK$. Using again $m \leq n+ \binom{q}{p}\leq n\binom{q}{p}$,
$\sigma'=O(\sigma + {q \choose p} n^3 +n(n\gamma+q\delta))$, we
obtain as a bound
\[
  \softO\left (
    {q \choose p}\,n^3\, c^2 +  c\, e\,n (\sigma+ {q \choose p}n^3 \, +n^2\gamma +nq \delta)
  \right ),
\]
