...
with $\balpha'=(\alpha'_1,\dots,\alpha'_{p'})$, $1 \le p' \le q'$, $p' \le p$ and $q' <
...
implies the existence of $\tilde b_\eta$, multiple of $b$, such that $\tilde
b_\eta\,
...
we may simplify the discussion by assuming that $\bi=(i,\dots,n)$. In
