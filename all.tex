...
$$\softO(m \,n^2 c^2 + n\, (m \sigma+n^2)\,c\,e )\subset (e\,\sigma\,m)^{O(1)}$$ operations in~$\KK$.
\end{proposition}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\text{\sf{cost:~}} \softO(c\,e\,n)$
\item\label{step:final} remove from $Z(\scrR_1)$ points that are not isolated in $V(\bC)$ \\
...
$\mathsf{Homotopy}$ at \ref{step:final} where the cleaning step we
