...
\begin{theorem}\label{theo:3}
  ...
  Then, there exist algorithms that solve Problem~\ref{problem3} in
  either
...
\begin{proposition}\label{prop:compute_isolated}
  % Assume that $\KK$ has characteristic zero and that
  % ${\assD}_1, {\assD}_2$ and ${\assD}_3$ hold. Letting $c$ be as in
  ...
  % operations in~$\KK$. {\bf xxx check probabilistic aspects.}
...
\begin{proposition}\label{prop:compute_regular}
  ...
  % Assume that ${\assD}_1, {\assD}_2$ and ${\assD}_3$ hold.
...
{\bf xxx -- Should we discuss what happens in case of failure?}
...
\xxx \check. The resulting algorithm, which we simply name
