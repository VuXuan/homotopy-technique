...
%p = 4, q = 5, deg = 65, prec = 128, den = 50, 7.4 sec.
%p = 4, q = 6, deg = 350, prec = 1024, den = 390, 1826 sec.

%p = 3, q = 6, deg = 301, prec = 2048, den = 540,  1690 sec.
%p = 3, q = 5, deg = 90, prec = 256, den = 125,  24.25 sec.
%p = 3, q = 4, deg = 25, prec = 64, den = 24,  0.5 sec.

%p = 2, q = 6, deg = 63, prec = 512, den = 186, 35.0  sec.
%p = 2, q = 5, deg = 31, prec = 256, den = 75, 5.0  sec.
%p = 2, q = 4, deg = 15, prec = 64, den = 28, 0.3  sec.
%p = 2, q = 3, deg = 7, prec = 32, den = 9, 0.1  sec.

%p = 2, q = 7, deg = 127, prec = 1024, den = 441, 245  sec.
