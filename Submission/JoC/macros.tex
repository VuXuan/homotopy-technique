...
\def\K {\ensuremath{\mathbb{K}}}
\def\KKbar {\ensuremath{\overline{\mathbb{K}}}}
\def\KKCbar {\ensuremath{\overline{\mathbb{K}(\mathfrak{G})}}}
\def\KKGbar {\ensuremath{\overline{\mathbb{K}(\mathfrak{L})}}}
\def\KKGpbar {\ensuremath{\overline{\mathbb{K}(\mathfrak{L}')}}}
\def\BS {\ensuremath{{B}}}
\def\CS {\ensuremath{{C}}}
\def\RS {\ensuremath{\mathsf{R}}}
\def\LL {\ensuremath{\mathbb{L}}}
\def\LLbar {\ensuremath{\overline{\mathbb{L}}}}
...
%% \def\mF{\ensuremath{{\boldmath{F}}}}
%% \def\mG{\ensuremath{{\boldmath{G}}}}

\DeclareBoldMathCommand{\bL}{L}
