...
\end{itemize}
From this, they deduce that the degree of the ideal generated
 by the $p$-minors of $\mF$
and $ g_1,\dots,g_s $ is at most \sloppy $\deg(g_1) \cdots
...
explicit expression for the Hilbert function of the ideal above, for a generic input.
...
$V(\bC)$, we need a suitable deformation of these equations.  We let
$T$ be a new variable, and we define the matrix
...
\begin{example}\label{ex:Npar}
  ...
  points in $V_p(\bL)$ (they may not be rational for other values of
...
\begin{example}
  ...
  $\bL$ as taken as in Example~\ref{ex:N}.
...
We are interested in describing the projective algebraic sets defined
in $\P^n(\KKbar)$ by the $p$-minors of $\bL^H$ and $\bP^H$ (note that
these minors are all homogeneous). In the rest of this section, if
...
\begin{proposition}\label{lemma:appendix2}
  ...
  \item the projective algebraic sets $V_p(\bP^H)$ and $V_p(\bL^H)$
    have no solution at infinity (that is, with $X_0=0$);
  \item the Jacobian matrices of $I_p(\bP^H)$ and $I_p(\bL^H)$ with
...
$\bP \in R^{p\times q}$, if $S$ is a subsequence of $(1,\dots,p)$ and
$T$ a subsequence of $(1,\dots,q)$, $\bP_{S,T}$ is the submatrix of
$\bP$ obtained by keeping rows indexed by $S$ and columns indexed by
$T$. We also call this the $(S,T)$-submatrix of $\bP$.
