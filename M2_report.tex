...
\end{proof}
Let $\h = (h_1, \ldots, h_M)$ be the determinantal systems of the homotopy matrix $H$ and let $\h_{0}^H = (h_{0,i}^H)_{1 \leq i \leq M}$ be the polynomials in $\bar{\field}[X_0, \mat{X}]^M$ obtained by homozenizing $(h_{0,i})_{1 \leq i \leq M}$ using a new variable $X_0$. 
